...
## File Structure
hospital-readmission-LOS-analysis/├── readmission_LOS_analysis.R # Core R code (data processing + modeling)├── readmission.csv # Sample patient dataset (desensitized)└── README.md # Project documentation
